...
## 6.1 Tecnologie Usate e Grado di Copertura
...
<div align="center" style="margin-bottom: 20px;">
    <img src="assets/test-coverage.png" alt="Report di Copertura sbt-scoverage" width="40%"/>
    <br>
    <em>Figura X: Report di copertura per package generato tramite sbt-scoverage.</em>
</div>
